...
RUN /usr/local/go/bin/go get -tags=no_env github.com/hemkantSplat/qt/cmd/...
...
COPY --from=base $GOPATH/src/github.com/hemkantSplat/qt $GOPATH/src/github.com/hemkantSplat/qt
...
RUN cd $GOPATH/src/github.com/hemkantSplat/qt/internal/examples/widgets/line_edits && $GOPATH/bin/qtdeploy build js && rm -rf ./deploy
