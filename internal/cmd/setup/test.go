...
import (
	...
	"github.com/hemkantSplat/qt/internal/binding/templater"

	"github.com/hemkantSplat/qt/internal/cmd"
	"github.com/hemkantSplat/qt/internal/cmd/deploy"
	"github.com/hemkantSplat/qt/internal/cmd/minimal"
	"github.com/hemkantSplat/qt/internal/cmd/moc"
	"github.com/hemkantSplat/qt/internal/cmd/rcc"
...
func Test(target string, docker, vagrant bool, vagrantsystem string) {
	...
	for cat, list := range examples {
		for _, example := range list {
			...
			path := filepath.Join(strings.TrimSpace(utils.GoListOptional("{{.Dir}}", "github.com/hemkantSplat/qt/internal/examples", "-find", "get doc dir")), example)
